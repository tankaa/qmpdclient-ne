...
system(which desktop-file-install > /dev/null) {
	...
	icon16.extra = cp -f ./icons/qmpdclient16.png $$icon16.path/qmpdclient.png
	icon22.path=$$PREFIX/share/icons/hicolor/22x22/apps
	icon22.extra = cp -f ./icons/qmpdclient22.png $$icon22.path/qmpdclient.png
	icon48.path=$$PREFIX/share/icons/hicolor/48x48/apps
	icon48.extra = cp -f ./icons/qmpdclient48.png $$icon48.path/qmpdclient.png
	iconSVG.path=$$PREFIX/share/icons/hicolor/scalable/apps
	iconSVG.extra = cp -f ./icons/svg/qmpdclient.svg $$iconSVG.path/qmpdclient.svg	
